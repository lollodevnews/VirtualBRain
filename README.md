...
* **Bare-Metal GPU Fusion (HIP/Triton):** Fusing the continuous polynomial S-Curve evaluation directly into the Matrix Multiplication SRAM steps to achieve native FP16 token throughput with a n-bit memory footprint.
